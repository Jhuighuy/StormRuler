...
c
      implicit none
      integer nx,ny
      double precision phi(nx,ny),cof(nx,ny,10),frhs(nx,ny)
      integer intl,nxa,nxb,nyc,nyd,ixp,jyq,iex,jey,nfx,nfy,iguess,
     +             maxcy,method,nwork,lwork,itero,ngrid,klevel,kcur,
     +             kcycle,iprer,ipost,intpol,kps
      double precision xa,xb,yc,yd,tolmax,relmax
     ...
     +               dxxxy4,dxyyy4,dxxyy,dlxxx,dlyyy
      ...
      double precision x,y,cxx,cxy,cyy,cx,cy,ce
      double precision alfaa,alfab,alfac,alfad,betaa,betab,betac,betad
      ...
      double precision txx,txy,tyy,tx,ty,tim1,ti,tip1,tjm1,tj,tjp1,ta,tb,tc,td
      double precision c1,c2,c3,c4,c5,c6,c7,c8
      double precision px4,px3y,px2y2,pxy3,py4,px3,py3,px3im1,py3jm1,px3jm1,py3im1
      external coef,bndyc
c
...
c
      implicit none
      integer nx,ny
      double precision cof(nx,ny,10),u(nx,ny),frhs(nx,ny)
      double precision dlx,dly,dyox,dxoy,dlx2,dly2,dlxx,dlxy,dlyy,dlxy2,
     +             dlxy4,dxxxy4,dxyyy4,dxxyy,tdlx3,tdly3,dlx4,dly4,
     +             dlxxx,dlyyy
      common/com2dcr/dyox,dxoy,dlx2,dly2,dlxy,dlxy2,dlxy4,
     +               dxxxy4,dxyyy4,dxxyy,dlxxx,dlyyy
      common/pde2com/dlx,dly,dlxx,dlyy,tdlx3,tdly3,dlx4,dly4
      double precision cxx,cxy,cyy,cx,cy
      integer i,j
      double precision txx,txy,tyy,tx,ty
      double precision px4,px3y,pxy3,py4,px3,py3
